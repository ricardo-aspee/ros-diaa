...
**kuka.ttt**: Scene que se carga en Coppelia con el móvil KUKA youBot.

**script.lua**: Script en lua que corresponde a Nodo 3: Nodo del Simulador Coppelia. Viene integrado a kuka.ttt por lo que es solo demostrativo.
...
2. Ejecución de *Nodo 1: Nodo de Teclado*, abrir un segundo terminal y ejecutar:
   ...
   Las Teclas asociadas a comandos son las siguientes:
   * **w**: Avance. Longitudinal, movimiento hacia al frente.
   * **s**: Retroceso. Longitudinal, movimiento hacia atrás.
   * **a**: Izquierda. Lateral, movimiento hacia la izquierda.
   * **d**: Derecha. Lateral, movimiento hacia la derecha.
   * **q**: Giro hacia la izquierda. Rotacional.
   * **e**: Giro hacia la derecha. Rotaciona.
   * **x**: Detención en todos los tipos de movimiento.
...
2. Ejecución de *Nodo 3: Nodo del Simulador Coppelia*, abrir un cuarto terminal y ejecutar:
   ...
   Una vez iniciado de Coppelia, se debe cargar la escena, para esto se accede a **File > Open Scene ...** y se selecciona el archivo **\~/Documents/catkin_taller1_ws/simulation_vrep/kuka.ttt**.
